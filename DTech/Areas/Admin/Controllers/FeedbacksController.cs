...
namespace DTech.Areas.Admin.Controllers
{
    ...
    public class FeedbacksController : Controller
    {
        ...
        public FeedbacksController(EcommerceWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FeedbackId,Name,Email,Detail,Fbdate")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FeedbackId,Name,Email,Detail,Fbdate")] Feedback feedback)
        {
